...
1. Скачайте из вкладки Releases архив версии, которая вас устраивает, расположите его в удобном месте и распакуйте.
...
### **Педали которые были проверены мной в работоспособностями с приложением**:
  - MOZA SR-P Pedal
  - Moza CRP2
  - Также приложение будет показывать и нажатие педалей самых простеньких рулей например - от производителя ALUCARD, но мёртвые зоны которые вы выставите в игре не будут показываться в приложении
